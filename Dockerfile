...
FROM quay.io/giantswarm/app-build-suite:1.2.1 AS abs

FROM quay.io/giantswarm/golang:1.21.4-alpine3.18 AS golang

FROM quay.io/giantswarm/conftest:v0.46.0 AS conftest
